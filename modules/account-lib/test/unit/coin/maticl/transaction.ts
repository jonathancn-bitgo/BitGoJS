...
import { Transaction } from '../../../../src/coin/maticl';
import * as testData from '../../../resources/maticl/maticl';
import { getCommon } from '../../../../src/coin/maticl/utils';

describe('MaticL Transaction', () => {
  const coinConfig = coins.get('tmaticl');
